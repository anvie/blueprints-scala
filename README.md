Tinkerpop Blueprints Scala [![Build Status](https://travis-ci.org/anvie/blueprints-scala.png?branch=master)](http://travis-ci.org/anvie/blueprints-scala)
===================================
...
Add dependency:
	...
	"com.ansvia.graph" % "blueprints-scala" % "0.0.2"

For Snapshot:

	"Ansvia snapshot repo" at "http://scala.repo.ansvia.com/snapshots/"

	"com.ansvia.graph" % "blueprints-scala" % "0.0.3-SNAPSHOT"
